        ...
        <nav class="navbar navbar-default navbar-fixed-top fadeInDown" data-wow-delay="0.5s">
            <div class="container">
                ...
                <div class="navbar-header page-scroll">
                   ...
                   <!-- Logo du site -->
                   <a class="navbar-brand smoothie logo logo-light" href="index.html"><img src="public/img/image/logo.png" alt="logo"></a>
                ...
                <div class="collapse navbar-collapse" id="main-navigation">
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown"> Voyages <span class="pe-7s-angle-down"></span></a>
                        ...
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-hover="dropdown" data-toggle="dropdown"> Hotêl <span class="pe-7s-angle-down"></span></a>
                        ...
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-hover="dropdown" data-toggle="dropdown"> Vol <span class="pe-7s-angle-down"></span></a>
                            <ul class="dropdown-menu" role="menu">
                        ...
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown"> Week end <span class="pe-7s-angle-down"></span></a>
                            <ul class="dropdown-menu">
                                <li class="dropdown-submenu">
                        ...
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown"> Carte cadeau <span class="pe-7s-angle-down"></span></a>
                            <ul class="dropdown-menu">
                                <li class="dropdown-submenu">
                        ...
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown"> Connexion <span class="pe-7s-angle-down"></span></a>
                            <ul class="dropdown-menu">
                                <li class="dropdown-submenu">
                        ...
                        <!-- Profil uniquement lorseque l'utilisateur est connecter -->
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-hover="dropdown" data-toggle="dropdown"> Profil <span class="pe-7s-angle-down"></span></a>
                            <ul class="dropdown-menu" role="menu">
...
>>>>>>> b4bf75d115de735916c0b5ae48185be739f1da4a
          <!-- Fin Menu -->